-- =====================================================
-- 학급 경제 교육 플랫폼 더미 데이터
-- fields 포맷: [{"name":"필드명","type":"text|number|date|select","options":[],"min":0,"max":100}]
-- =====================================================
...
-- =====================================================
-- 4. Job_Actions (typed fields 포맷 적용)
-- =====================================================

-- 감사원: 감사 대장
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (1, 1, 4, '{
  "title": "필수 직업 감사 대장",
  "fields": [
...
-- 감사원: 학급 회의 기록
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (2, 1, 5, '{
  "title": "학급 회의 기록",
  "fields": [
...
-- 은행원: 월급 확인 체크리스트
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (3, 2, 2, '{
  "title": "월급 확인 체크리스트",
  "fields": [
...
-- 은행원: 예금 판매 대장
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (4, 2, 1, '{
  "title": "예금 판매 대장",
  "fields": [
    {"name":"가입자",       "type":"text"},
...
-- 통계청: 제출물 현황 통계표
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (5, 3, 3, '{
  "title": "제출물 현황 통계표",
  "fields": [
    {"name":"날짜",        "type":"date"},
...
-- 경찰: 벌금 대장
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (6, 4, 1, '{
  "title": "벌금 대장",
  "fields": [
    {"name":"납부자",   "type":"text"},
...
-- 신용평가위원: 신용 평가 보고서
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (7, 5, 3, '{
  "title": "신용 평가 보고서",
  "fields": [
...
-- 신용평가위원: 민원 처리 대장
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (8, 5, 6, '{
  "title": "민원 처리 대장",
  "fields": [
    {"name":"민원인",   "type":"text"},
...
-- 노동청: 업무 수행 점검표
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (9, 6, 2, '{
...
-- 노동청: 민원 처리 대장
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (10, 6, 6, '{
  "title": "민원 처리 대장",
  "fields": [
    {"name":"민원인",   "type":"text"},
    {"name":"민원 내용","type":"text"},
...
-- 국세청: 세수 입출금 대장
INSERT INTO Job_Actions (id, job_id, action_id, action_config) VALUES (11, 7, 1, '{
  "title": "세수 입출금 대장",
  "fields": [
    {"name":"항목",   "type":"text"},
